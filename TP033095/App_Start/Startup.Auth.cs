    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseOpenIdConnectAuthentication(
                ...
                {
                    ClientId = TP033095.Utils.ConfigHelper.ClientId,
                    Authority = String.Format(CultureInfo.InvariantCulture, TP033095.Utils.ConfigHelper.AadInstance, TP033095.Utils.ConfigHelper.Tenant), // For Single-Tenant
                   // Authority = TP033095.Utils.ConfigHelper.CommonAuthority, // For Multi-Tenant
                    PostLogoutRedirectUri = TP033095.Utils.ConfigHelper.PostLogoutRedirectUri,
